package com.example.biac.newstop.Activity;
...
import com.example.biac.newstop.presenter.implPresenter.TopNewsDesPresenterImpl;
...
import com.example.biac.newstop.util.GlideUtils;
import com.example.biac.newstop.util.Urls;
import com.example.biac.newstop.util.ViewUtils;
import com.example.biac.newstop.widget.ElasticDragDismissFrameLayout;
import com.example.biac.newstop.widget.ParallaxScrimageView;
import com.example.biac.newstop.widget.TranslateYTextView;

import org.sufficientlysecure.htmltextview.HtmlTextView;

public class TopNewsDescribeActivity extends Activity implements ITopNewsDesFragment{
    ...
    private TranslateYTextView mTextView;
    ...
    public void initView(){
        ...
        mShot = (ParallaxScrimageView)findViewById(R.id.shot);
        mToolbar = (Toolbar)findViewById(R.id.toolbar);
        mDraggableFrame = (ElasticDragDismissFrameLayout)findViewById(R.id.draggable_frame);
        mNest = (NestedScrollView) findViewById(R.id.nest);
        mTextView = (TranslateYTextView)findViewById(R.id.title);
