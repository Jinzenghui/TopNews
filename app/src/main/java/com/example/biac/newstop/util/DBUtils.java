...
public class DBUtils {
    ...
    public static final String CREATE_TABLE_IF_NOT_EXTISTS = "create table if not exists %s"
    ...
    public class DBHelper extends SQLiteOpenHelper{
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXTISTS, Config.ZHIHU));
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXTISTS, Config.TOPNEWS));
        }
